      ...
      <div className="fixed top-40 bottom-40 left-0 right-0 flex justify-center items-center backdrop-blur-sm">
        <div className="relative p-4 w-full max-w-md ">
          <div className="relative bg-white shadow rounded-lg">
            <div
              className="flex items-center justify-between p-4 border-b rounded-t bg-slate-500"
              // style={{ backgroundColor: "#0766AD" }}
            >
              <h3 className="text-xl font-semibold text-gray-100 hover:text-white ">
            ...
            <div className="p-4" style={{ backgroundColor: "#F3F3F3" }}>
              <form className="space-y-4" action="#">
                ...
                <button
                  type="button"
                  className="w-full text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5"
